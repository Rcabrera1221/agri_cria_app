                          ...
                          builder: (context, snapshot) {
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                _buildSummaryRow(Icons.monitor_weight,
                                    'Peso promedio: ${data['pesoPromedioGeneral']}'),
                                _buildSummaryRow(Icons.grass,
                                    'Alimentacion promedio: ${data['alimentacionPromedioPorAnimal']}'),
                                _buildSummaryRow(Icons.attach_money,
                                    'Costo total \$: ${data['costoTotalAlimentacion']}%'),
                                _buildSummaryRow(Icons.pets,
                                    'Nro total animales${data['numeroTotalAnimales']}'),
                              ],
                            );
                          },
                        ),
...
Future<Map<String, dynamic>> fetchDashboardData() async {
  ...
  const url =
      'https://api-agri-cria-production.up.railway.app/api/dashboardGanadero';
  //const url = 'http://localhost:3000/api/dashboardGanadero';
